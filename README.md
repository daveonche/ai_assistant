...
Installs and updates always retrieve the pinned release tag `v1.0.4`,
...
```bash
curl -fsSL https://raw.githubusercontent.com/daveonche/ai_assistant/v1.0.4/scripts/install.sh | grep -E 'DEFAULT_REF=|no commits yet'
```
